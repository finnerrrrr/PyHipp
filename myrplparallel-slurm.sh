...
# Distinct notification for this script
aws sns publish --region ap-southeast-1 \
  --topic-arn arn:aws:sns:ap-southeast-1:543346795359:awsnotify \
  --message "RPLParallelJobDone" || echo "SNS publish failed; continuing"
